...
pub struct PageBeanResolutionJsonBean {
    ...
    pub values: Option<Vec<models::ResolutionJsonBean>>,
}

impl PageBeanResolutionJsonBean {
    /// A page of items.
    pub fn new() -> PageBeanResolutionJsonBean {
