...
pub struct PageBeanNotificationSchemeAndProjectMappingJsonBean {
    ...
    pub values: Option<Vec<models::NotificationSchemeAndProjectMappingJsonBean>>,
}

impl PageBeanNotificationSchemeAndProjectMappingJsonBean {
    /// A page of items.
    pub fn new() -> PageBeanNotificationSchemeAndProjectMappingJsonBean {
