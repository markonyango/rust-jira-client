...
pub struct PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects {
    ...
    pub values: Option<Vec<models::PrioritySchemeWithPaginatedPrioritiesAndProjects>>,
}

impl PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects {
    /// A page of items.
    pub fn new() -> PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects {
