...
pub struct PageBeanSecuritySchemeWithProjects {
    ...
    pub values: Option<Vec<models::SecuritySchemeWithProjects>>,
}

impl PageBeanSecuritySchemeWithProjects {
    /// A page of items.
    pub fn new() -> PageBeanSecuritySchemeWithProjects {
