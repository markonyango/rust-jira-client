...
pub struct PageBeanUiModificationDetails {
    ...
    pub values: Option<Vec<models::UiModificationDetails>>,
}

impl PageBeanUiModificationDetails {
    /// A page of items.
    pub fn new() -> PageBeanUiModificationDetails {
