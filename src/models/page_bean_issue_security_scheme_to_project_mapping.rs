...
pub struct PageBeanIssueSecuritySchemeToProjectMapping {
    ...
    pub values: Option<Vec<models::IssueSecuritySchemeToProjectMapping>>,
}

impl PageBeanIssueSecuritySchemeToProjectMapping {
    /// A page of items.
    pub fn new() -> PageBeanIssueSecuritySchemeToProjectMapping {
