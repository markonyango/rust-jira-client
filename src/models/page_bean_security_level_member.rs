...
pub struct PageBeanSecurityLevelMember {
    ...
    pub values: Option<Vec<models::SecurityLevelMember>>,
}

impl PageBeanSecurityLevelMember {
    /// A page of items.
    pub fn new() -> PageBeanSecurityLevelMember {
