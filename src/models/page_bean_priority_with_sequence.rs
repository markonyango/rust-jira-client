...
pub struct PageBeanPriorityWithSequence {
    ...
    pub values: Option<Vec<models::PriorityWithSequence>>,
}

impl PageBeanPriorityWithSequence {
    /// A page of items.
    pub fn new() -> PageBeanPriorityWithSequence {
