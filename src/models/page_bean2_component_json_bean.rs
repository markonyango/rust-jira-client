...
pub struct PageBean2ComponentJsonBean {
    ...
    pub values: Option<Vec<models::ComponentJsonBean>>,
}

impl PageBean2ComponentJsonBean {
    /// A page of items.
    pub fn new() -> PageBean2ComponentJsonBean {
