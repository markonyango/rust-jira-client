...
pub async fn read_workflow_schemes(configuration: &configuration::Configuration, workflow_scheme_read_request: models::WorkflowSchemeReadRequest, expand: Option<&str>) -> Result<Vec<models::WorkflowSchemeReadResponse>, Error<ReadWorkflowSchemesError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/workflowscheme/read", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn update_schemes(configuration: &configuration::Configuration, workflow_scheme_update_request: models::WorkflowSchemeUpdateRequest) -> Result<serde_json::Value, Error<UpdateSchemesError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/workflowscheme/update", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn update_workflow_scheme_mappings(configuration: &configuration::Configuration, workflow_scheme_update_required_mappings_request: models::WorkflowSchemeUpdateRequiredMappingsRequest) -> Result<models::WorkflowSchemeUpdateRequiredMappingsResponse, Error<UpdateWorkflowSchemeMappingsError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/workflowscheme/update/mappings", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
