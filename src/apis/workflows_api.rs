...
pub async fn create_workflows(configuration: &configuration::Configuration, workflow_create_request: models::WorkflowCreateRequest) -> Result<models::WorkflowCreateResponse, Error<CreateWorkflowsError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/workflows/create", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn read_workflows(configuration: &configuration::Configuration, workflow_read_request: models::WorkflowReadRequest, expand: Option<&str>, use_transition_links_format: Option<bool>, use_approval_configuration: Option<bool>) -> Result<models::WorkflowReadResponse, Error<ReadWorkflowsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/rest/api/2/workflows", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = expand {
        local_var_req_builder = local_var_req_builder.query(&[("expand", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = use_transition_links_format {
        local_var_req_builder = local_var_req_builder.query(&[("useTransitionLinksFormat", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = use_approval_configuration {
        local_var_req_builder = local_var_req_builder.query(&[("useApprovalConfiguration", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn update_workflows(configuration: &configuration::Configuration, workflow_update_request: models::WorkflowUpdateRequest, expand: Option<&str>) -> Result<models::WorkflowUpdateResponse, Error<UpdateWorkflowsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/rest/api/2/workflows/update", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn validate_create_workflows(configuration: &configuration::Configuration, workflow_create_validate_request: models::WorkflowCreateValidateRequest) -> Result<models::WorkflowValidationErrorList, Error<ValidateCreateWorkflowsError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/workflows/create/validation", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn validate_update_workflows(configuration: &configuration::Configuration, workflow_update_validate_request_bean: models::WorkflowUpdateValidateRequestBean) -> Result<models::WorkflowValidationErrorList, Error<ValidateUpdateWorkflowsError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/workflows/update/validation", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn workflow_capabilities(configuration: &configuration::Configuration, workflow_id: Option<&str>, project_id: Option<&str>, issue_type_id: Option<&str>) -> Result<models::WorkflowCapabilities, Error<WorkflowCapabilitiesError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/workflows/capabilities", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
