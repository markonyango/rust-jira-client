...
pub async fn create_issue_type(configuration: &configuration::Configuration, issue_type_create_bean: models::IssueTypeCreateBean) -> Result<models::IssueTypeDetails, Error<CreateIssueTypeError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/issuetype", local_var_configuration.base_path);
...
pub async fn create_issue_type_avatar(configuration: &configuration::Configuration, id: &str, size: i32, body: Option<serde_json::Value>, x: Option<i32>, y: Option<i32>) -> Result<models::Avatar, Error<CreateIssueTypeAvatarError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/issuetype/{id}/avatar2", local_var_configuration.base_path, id=crate::apis::urlencode(id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn delete_issue_type(configuration: &configuration::Configuration, id: &str, alternative_issue_type_id: Option<&str>) -> Result<(), Error<DeleteIssueTypeError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/issuetype/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
...
pub async fn get_alternative_issue_types(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::IssueTypeDetails>, Error<GetAlternativeIssueTypesError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/issuetype/{id}/alternatives", local_var_configuration.base_path, id=crate::apis::urlencode(id));
...
pub async fn get_issue_types_for_project(configuration: &configuration::Configuration, project_id: i64, level: Option<i32>) -> Result<Vec<models::IssueTypeDetails>, Error<GetIssueTypesForProjectError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/rest/api/2/issuetype/project", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
