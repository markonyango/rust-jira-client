...
pub async fn get_accessible_project_type_by_key(configuration: &configuration::Configuration, project_type_key: &str) -> Result<models::ProjectType, Error<GetAccessibleProjectTypeByKeyError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/project/type/{projectTypeKey}/accessible", local_var_configuration.base_path, projectTypeKey=crate::apis::urlencode(project_type_key));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccessibleProjectTypeByKeyError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_all_accessible_project_types(configuration: &configuration::Configuration, ) -> Result<Vec<models::ProjectType>, Error<GetAllAccessibleProjectTypesError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/project/type/accessible", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllAccessibleProjectTypesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_all_project_types(configuration: &configuration::Configuration, ) -> Result<Vec<models::ProjectType>, Error<GetAllProjectTypesError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/project/type", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllProjectTypesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_project_type_by_key(configuration: &configuration::Configuration, project_type_key: &str) -> Result<models::ProjectType, Error<GetProjectTypeByKeyError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/project/type/{projectTypeKey}", local_var_configuration.base_path, projectTypeKey=crate::apis::urlencode(project_type_key));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectTypeByKeyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
