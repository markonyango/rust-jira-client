...
pub async fn delete_project_property(configuration: &configuration::Configuration, project_id_or_key: &str, property_key: &str) -> Result<(), Error<DeleteProjectPropertyError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/project/{projectIdOrKey}/properties/{propertyKey}", local_var_configuration.base_path, projectIdOrKey=crate::apis::urlencode(project_id_or_key), propertyKey=crate::apis::urlencode(property_key));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteProjectPropertyError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_project_property(configuration: &configuration::Configuration, project_id_or_key: &str, property_key: &str) -> Result<models::EntityProperty, Error<GetProjectPropertyError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectPropertyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_project_property_keys(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<models::PropertyKeys, Error<GetProjectPropertyKeysError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/project/{projectIdOrKey}/properties", local_var_configuration.base_path, projectIdOrKey=crate::apis::urlencode(project_id_or_key));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectPropertyKeysError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn set_project_property(configuration: &configuration::Configuration, project_id_or_key: &str, property_key: &str, body: Option<serde_json::Value>) -> Result<serde_json::Value, Error<SetProjectPropertyError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetProjectPropertyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
