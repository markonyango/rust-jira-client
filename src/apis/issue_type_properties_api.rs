...
pub async fn delete_issue_type_property(configuration: &configuration::Configuration, issue_type_id: &str, property_key: &str) -> Result<(), Error<DeleteIssueTypePropertyError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/issuetype/{issueTypeId}/properties/{propertyKey}", local_var_configuration.base_path, issueTypeId=crate::apis::urlencode(issue_type_id), propertyKey=crate::apis::urlencode(property_key));
...
pub async fn get_issue_type_property_keys(configuration: &configuration::Configuration, issue_type_id: &str) -> Result<models::PropertyKeys, Error<GetIssueTypePropertyKeysError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/issuetype/{issueTypeId}/properties", local_var_configuration.base_path, issueTypeId=crate::apis::urlencode(issue_type_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
