...
pub async fn get_default_project_classification(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<serde_json::Value, Error<GetDefaultProjectClassificationError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/2/project/{projectIdOrKey}/classification-level/default", local_var_configuration.base_path, projectIdOrKey=crate::apis::urlencode(project_id_or_key));
