...
[**replace_custom_field_option**](IssueCustomFieldOptionsApi.md#replace_custom_field_option) | **DELETE** /rest/api/2/field/{fieldId}/context/{contextId}/option/{optionId}/issue | Replace custom field options
