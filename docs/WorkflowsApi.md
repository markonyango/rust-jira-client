...
[**create_workflows**](WorkflowsApi.md#create_workflows) | **POST** /rest/api/2/workflows/create | Bulk create workflows
...
[**read_workflows**](WorkflowsApi.md#read_workflows) | **POST** /rest/api/2/workflows | Bulk get workflows
[**update_workflows**](WorkflowsApi.md#update_workflows) | **POST** /rest/api/2/workflows/update | Bulk update workflows
[**validate_create_workflows**](WorkflowsApi.md#validate_create_workflows) | **POST** /rest/api/2/workflows/create/validation | Validate create workflows
[**validate_update_workflows**](WorkflowsApi.md#validate_update_workflows) | **POST** /rest/api/2/workflows/update/validation | Validate update workflows
[**workflow_capabilities**](WorkflowsApi.md#workflow_capabilities) | **GET** /rest/api/2/workflows/capabilities | Get available workflow capabilities
